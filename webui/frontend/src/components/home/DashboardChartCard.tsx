...
export default function DashboardChartCard() {
  ...
  return (
    <div className={cardStyle} style={cardShadow}>
      <h2 className="text-black/80 mb-4" style={titleStyle}>仪表盘</h2>

      <div className="flex items-center gap-4 mb-4">
        <div className="flex items-center gap-2">
          <span className="text-black/50" style={labelStyle}>时间粒度</span>
        ...
        <div className="flex items-center gap-2">
          <span className="text-black/50" style={labelStyle}>实例区分</span>
          <button
      ...
      <div className="flex-1 flex items-center justify-center rounded-[20px] border-2 border-dashed border-black/20 min-h-[120px]">
        <span className="text-black/30" style={labelStyle}>图表区域（待实现）</span>
      </div>
    </div>
  )
}
