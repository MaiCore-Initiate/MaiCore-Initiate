...
export default function EditProjectDialog({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="relative flex max-h-[92vh] w-[94%] max-w-2xl flex-col rounded-2xl border border-[var(--mc-border-muted)] bg-[var(--mc-panel-solid)] text-[var(--mc-text-primary)] shadow-2xl">
        ...
        <div className="flex-1 space-y-5 overflow-auto px-6 py-5">
          ...
          <div>
            ...
            <input
              ...
              maxLength={128}
              className="mt-2 w-full rounded-lg border border-[var(--mc-border-muted)] bg-[var(--mc-control-bg-soft)] px-3 py-2 text-sm text-[var(--dfw-text)] outline-none focus:border-[var(--dfw-blue)]"
            />
            {!modNameValid && (
              <p className="workbench-alert workbench-alert-warning mt-2 rounded-md px-3 py-2 text-xs">⚠ 项目名称不能为空且不超过 128 字符</p>
            )}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              maxLength={2000}
              className="mt-2 w-full resize-y rounded-lg border border-[var(--mc-border-muted)] bg-[var(--mc-control-bg-soft)] px-3 py-2 text-sm text-[var(--dfw-text)] outline-none focus:border-[var(--dfw-blue)]"
            />
          </div>
          ...
          <div>
            ...
            <input
              value={project.path}
              readOnly
              className="mt-2 w-full rounded-lg border border-[var(--mc-border-muted)] bg-[var(--mc-control-bg-soft)] px-3 py-2 font-mono text-xs text-[var(--dfw-text)] opacity-80"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-2 flex items-start gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  type="button"
                  className="rounded-md border border-[var(--mc-border-muted)] bg-transparent px-3 py-1.5 text-sm text-[var(--dfw-text)] transition hover:bg-[var(--mc-control-hover)]"
