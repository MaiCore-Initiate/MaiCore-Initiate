...
function ExeIcon({ size = 48, className }: FileIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      ...
      aria-hidden
    >
      <path fill="#ECEDEF" d="M100.641 0c-14.139 0-25.6 11.461-25.6 25.6v460.8c0 14.139 11.461 25.6 25.6 25.6h375.467c14.139 0 25.6-11.461 25.6-25.6V85.333L416.375 0H100.641z" />
      <path fill="#D9DCDF" d="M441.975 85.333h59.733L416.375 0v59.733c0 14.139 11.461 25.6 25.6 25.6z" />
      <path fill="#C6CACF" d="M399.308 42.667H75.041v153.6h324.267c4.713 0 8.533-3.821 8.533-8.533V51.2c0-4.713-3.821-8.533-8.533-8.533z" />
      <path fill="#DB6B5E" d="M382.241 179.2H18.843c-7.602 0-11.41-9.191-6.034-14.567L75.041 102.4 12.809 40.167C7.433 34.791 11.241 25.6 18.843 25.6h363.398c4.713 0 8.533 3.821 8.533 8.533v136.533c.001 4.713-3.82 8.534-8.533 8.534z" />
      <path fill="#FFF" d="M185.975 93.867c4.713 0 8.533-3.821 8.533-8.533s-3.821-8.533-8.533-8.533h-34.133c-4.713 0-8.533 3.821-8.533 8.533v51.2c0 4.713 3.821 8.533 8.533 8.533h34.133c4.713 0 8.533-3.821 8.533-8.533S190.687 128 185.975 128h-25.6v-8.533h8.533c4.713 0 8.533-3.821 8.533-8.533s-3.821-8.533-8.533-8.533h-8.533v-8.533h25.6z" />
      <path fill="#FFF" d="M305.441 128h-25.6v-8.533h8.533c4.713 0 8.533-3.821 8.533-8.533s-3.821-8.533-8.533-8.533h-8.533v-8.533h25.6c4.713 0 8.533-3.821 8.533-8.533s-3.821-8.533-8.533-8.533h-34.133c-4.713 0-8.533 3.821-8.533 8.533v51.2c0 4.713 3.821 8.533 8.533 8.533h34.133c4.713 0 8.533-3.821 8.533-8.533S310.154 128 305.441 128z" />
      <path fill="#FFF" d="M250.442 78.234c-3.924-2.618-9.221-1.554-11.834 2.367l-9.967 14.95-9.967-14.95c-2.612-3.921-7.913-4.981-11.834-2.367-3.922 2.614-4.981 7.911-2.367 11.834l13.913 20.866-13.911 20.867c-2.39 3.585-1.671 8.551 1.651 11.301 3.851 3.187 9.779 2.322 12.549-1.835l9.967-14.95 9.967 14.95c2.769 4.156 8.699 5.022 12.549 1.835 3.323-2.75 4.042-7.715 1.651-11.301l-13.913-20.867 13.911-20.867c2.618-3.923 1.558-9.221-2.363-11.834z" />
      <path fill="#C6CACF" d="M407.841 452.267H168.908c-9.426 0-17.067-7.641-17.067-17.067V256c0-9.426 7.641-17.067 17.067-17.067h238.933c9.426 0 17.067 7.641 17.067 17.067v179.2c0 9.426-7.641 17.067-17.067 17.067z" />
      <path fill="#B3B9BF" d="M177.441 435.2V256c0-9.425 7.641-17.067 17.067-17.067h-25.6c-9.426 0-17.067 7.642-17.067 17.067v179.2c0 9.425 7.641 17.067 17.067 17.067h25.6c-9.425 0-17.067-7.642-17.067-17.067z" />
      <path fill="#7B848F" d="M424.908 256c0-9.425-7.642-17.067-17.067-17.067H168.908c-9.426 0-17.067 7.642-17.067 17.067v68.622h273.067V256z" />
      <path fill="#68727E" d="M194.508 238.933h-25.6c-9.426 0-17.067 7.642-17.067 17.067v68.622h25.6V256c0-9.425 7.642-17.067 17.067-17.067z" />
      <path fill="#55606E" d="M203.044 426.667c-3.691 0-7.055-2.468-8.151-5.993-.993-3.191.014-6.762 2.53-8.962l26.794-23.445-26.794-23.444c-3.5-3.061-3.865-8.542-.803-12.042 3.061-3.5 8.542-3.866 12.041-.802l34.133 29.867c3.828 3.349 3.828 9.494 0 12.844l-34.133 29.867c-1.619 1.414-3.622 2.11-5.617 2.11z" />
      <path fill="#55606E" d="M279.841 426.667h-17.067c-4.713 0-8.533-3.821-8.533-8.533s3.821-8.533 8.533-8.533h17.067c4.713 0 8.533 3.821 8.533 8.533s-3.82 8.533-8.533 8.533z" />
      <circle cx="254.24" cy="281.6" r="25.6" fill="#4FA9EA" />
      <circle cx="254.24" cy="281.6" r="17.067" fill="#558CCF" />
      <circle cx="313.973" cy="281.6" r="25.6" fill="#FF9785" />
      <circle cx="313.973" cy="281.6" r="17.067" fill="#DF7A6E" />
      <circle cx="373.707" cy="281.6" r="25.6" fill="#FFCA61" />
      <circle cx="373.707" cy="281.6" r="17.067" fill="#F8A95F" />
    </svg>
  )
}

function YamlIcon({ size = 48, className }: FileIconProps) {
  return (
    <svg
      fill="#CB171E"
      role="img"
...
function XmlIcon({ size = 48, className }: FileIconProps) {
  return (
    <svg
      fill="#005FAD"
      role="img"
