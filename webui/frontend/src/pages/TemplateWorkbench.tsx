" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" />
      <path stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" d="M19 4L19 11L26 11" />
      <path stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" d="M12.5 18.5L16 15L19.5 18.5" />
      <path stroke="currentColor" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" d="M16 23L16 15" />
    </svg>
  )
}
...
function QuickActions({
  ...
  const actions = [
    {
      label: '打包项目',
      description: '打包您调试好的模板文件，用于分发它们',
  ...
  return (
    <div className="absolute flex gap-[30px]" style={{ left: 400, top: 196, width: 630, height: 61, color: 'var(--twb-text)' }}>
      {actions.map(({ label, description, descriptionSize, onClick, icon }) => (
        <button
          key={label}
          type="button"
          onClick={onClick}
          ...
          aria-label={label}
        >
          <span className="absolute left-[5px] top-[10px] flex h-[41px] w-[41px] items-center justify-center" aria-hidden>
            {icon}
          </span>
          <span className="absolute left-[58px] top-[22px] leading-none" style={{ fontFamily: font, fontSize: 22, fontWeight: 500 }}>
            {label}
          </span>
          <span className="absolute left-[58px] top-[44px] w-[238px] whitespace-nowrap leading-none" style={{ color: 'var(--twb-muted)', fontFamily: font, fontSize: descriptionSize, fontWeight: 300 }}>
            {description}
          </span>
        </button>
      ))}
...
export default function TemplateWorkbench({
  ...
  const contentItems = useMemo(() => {
    ...
    if (route.type === 'home') return deploymentFlowItems
  ...
  }, [activeSection, deploymentFlowItems, route, selectedProject, coverVersion, starredFlowItems])
  ...
  const visibleContentItems = useMemo(() => {
    ...
    const searchSourceItems = route.type === 'home' ? deploymentFlowItems : globalSearchItems
    if (exactSearchEnabled) return searchSourceItems.filter(item => item.name === searchQuery)

    const fuzzyQuery = trimmedQuery.toLowerCase()
    return searchSourceItems.filter(item => item.name.toLowerCase().includes(fuzzyQuery))
  }, [contentItems, deploymentFlowItems, globalSearchItems, route, searchQuery, exactSearchEnabled])
  ...
  const showPackageProjectPlaceholder = () => {
    setActionError('打包项目功能入口已预留，当前尚未接入模板打包业务流程。')
  }

  const showPublishProjectPlaceholder = () => {
    setActionError('发布项目功能入口已预留，当前尚未接入模板发布业务流程。')
  }
    ...
    <div className="template-workbench relative h-full w-full overflow-hidden" style={{ background: 'var(--twb-bg)', color: 'var(--twb-text)' }}>
      ...
      <header className="absolute left-[350px] top-0 z-10 h-[71px] w-[1570px] border-b" style={{ borderColor: 'var(--twb-border)' }}>
        <button
          type="button"
          disabled
          className="absolute flex cursor-not-allowed items-center justify-center opacity-35"
      ...
      <main className="absolute left-0 top-0 z-0 w-[1920px] pb-[80px]" style={{ minHeight: mainMinHeight }}>
        ...
        <QuickActions
          onPackageProject={showPackageProjectPlaceholder}
          onPublishProject={showPublishProjectPlaceholder}
        />
