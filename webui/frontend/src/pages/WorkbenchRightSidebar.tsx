...
import type { WorkbenchBlockId, WorkbenchComponentMeta, WorkbenchConfigItemMeta, WorkbenchCustomInstallRule, WorkbenchDeploymentMeta, WorkbenchEnvVariableEntry, WorkbenchFileMeta, WorkbenchLaunchItemMeta, WorkbenchUninstallItemMeta, WorkbenchVersionFormattingRule } from './workbench-canvas/types'
...
interface CustomInstallRuleItem {
  id: string
...
function createCustomInstallRuleItem(value: WorkbenchCustomInstallRule): CustomInstallRuleItem {
  arrayListItemId += 1
  return {
...
function CustomInstallRuleField({
  label,
  values,
  onChange,
  maxWidth,
