...
`.mcsins` 本质是 **ISO 9660 (Joliet Level 3)** 文件，内部包含两个文件：
...
# 添加描述
mcsb -o 1 -des "这是一个测试实例，用于验证打包功能"
...
1. **GitHub 登录必须**：打包前必须通过 `mcsb login github.com` 登录 GitHub，作者信息从账户数据读取。
